...
ms = 2
P = plot(framestyle=:box, legend=:bottomleft,font="Computer Modern", titlefont = "Computer Modern",tickfontfamily="Computer Modern",legendfont="Computer Modern", guidefontfamily = "Computer Modern",
...
plot!(τ, l1, color = :blue, linestyle =:solid, markershape=:circle, markersize = ms, label = "Ours (Skew)")
...
xlabel!(L"\Vert \Omega\ \Vert_\mathrm{F} \ /\ \Vert A\ \Vert_\mathrm{F}")   
